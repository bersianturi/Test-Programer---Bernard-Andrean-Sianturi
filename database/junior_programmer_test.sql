...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2025 at 01:30 PM
...
(70, 'BOTOL KOTAK 100ML LK', '1000.00', 7, 1),
(72, 'BOTOL 10ML IM', '1000.00', 8, 2);
...
ALTER TABLE `produk`
  ...
  ADD CONSTRAINT `produk_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `status` (`id_status`) ON DELETE SET NULL;
COMMIT;
